...
const CreatePage = () => {
  ...
  return (
    <div className="flex justify-center items-center pt-20 px-4 sm:px-6 md:px-8 lg:px-16">
      <div className="max-w-md lg:max-w-3xl w-full bg-gray-50 dark:bg-gray-600 p-8 sm:p-10 shadow-xl rounded-3xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6 relative">
            <input
              ...
              className="w-full p-4 pl-12 border border-gray-300 dark:border-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:text-gray-200"
            />
