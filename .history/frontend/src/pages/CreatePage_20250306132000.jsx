        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <motion.div
              ...
              animate={{ rotateY: 180 }} // Flip the icon horizontally
              transition={{
                duration: 2, // Increased flip duration (slower flip)
                repeat: Infinity, // Repeat the flip infinitely
                repeatType: "mirror", // Mirror the flip back and forth
                delay: 0.2, // Delay before the flip starts
                repeatDelay: 7, // Delay between flips (7 seconds)
              }}
            >
              <FaRegFileAlt />
            </motion.div>
          ...
          >
            ...
            <motion.div
              ...
              transition={{
                ...
                repeat: Infinity, // Repeat the flip infinitely
                repeatType: "mirror", // Mirror the flip back and forth
                delay: 0.4, // Delay before the flip starts
                repeatDelay: 7, // Delay between flips (7 seconds)
              }}
            >
              <FaTag />
          ...
          >
            ...
            <motion.div
              ...
              transition={{
                ...
                repeat: Infinity, // Repeat the flip infinitely
                repeatType: "mirror", // Mirror the flip back and forth
                delay: 0.6, // Delay before the flip starts
                repeatDelay: 7, // Delay between flips (7 seconds)
              }}
            >
              <FaImage />
