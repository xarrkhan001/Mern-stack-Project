  ...
  return (
    <div className="max-w-2xl py-12 mx-auto text-center">
      ...
      <div className="mt-8">
        <Link to="/create">
          <button
            className="px-8 py-3 text-white bg-blue-500 hover:bg-blue-600 font-semibold rounded-lg shadow-md transform transition duration-200 ease-in-out hover:scale-105"
            style={{
