      ...
      <div className="max-w-[1140px] px-4 mx-auto">
        ...
        <div className="flex items-center justify-between h-20 bg-[#4B421B] p-4 rounded-xl shadow-lg">
          ...
          <Link to="/" className="font-bold flex items-center space-x-2">
            <span className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#FFFFFF] to-[#FF80AB]">
              Product
            </span>
            <span className="text-3xl text-white font-serif">Store</span>
          </Link>
