      ...
      <div className="max-w-[1140px] px-4 mx-auto">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="font-bold flex items-center">
            <span className="text-3xl bg-clip-text text-transparent bg-gradient-to-r from-[#FF4081] to-[#FF80AB] mr-1">
              Product
            </span>
            <span className="text-[#231651] text-lg font-cursive">Storekk</span>
          </Link>
