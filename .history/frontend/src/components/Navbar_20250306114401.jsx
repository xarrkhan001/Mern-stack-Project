  ...
  return (
    <>
      <div className="max-w-[1140px] px-4 mx-auto">
        {/* Navbar container */}
        <div
          className={`flex items-center justify-between h-20 p-4 rounded-xl shadow-lg text-black dark:text-white ${
            isDarkMode ? "bg-transparent dark:bg-transparent" : "bg-gray-100"
          }`}
        >
          ...
          <div className="relative flex items-center space-x-4">
            {/* Plus Icon */}
            <Link to="/create">
              <button className="w-12 h-12 bg-white dark:bg-gray-500 text-[#FF4081] dark:text-white rounded-full flex items-center justify-center transform hover:scale-125 transition-all duration-300 shadow-xl hover:shadow-2xl focus:outline-none">
            ...
            >
              {isDarkMode ? (
                <FaSun size={18} className="text-yellow-600" /> // Sun icon with yellow color for dark mode
              ) : (
