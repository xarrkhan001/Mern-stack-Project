      ...
      <div className="max-w-[1140px] px-4 mx-auto">
        ...
        <div className="flex items-center justify-between h-20 bg-transparent dark:bg-transparent p-4 rounded-xl shadow-lg text-black dark:text-white">
          ...
          <Link to="/" className="flex items-center">
            {/* Logo-style text */}
            <span
              className="font-logo text-5xl tracking-tighter text-red-500 dark:text-gray-100"
              style={{
                fontFamily: "'Monoton', cursive",
                letterSpacing: "-2px", // Reduce letter spacing for a joined look
                lineHeight: "1.1", // Tighter line height
                textShadow: "1px 1px 2px rgba(0, 0, 0, 0.5)", // Adding text shadow for depth
            ...
            >
              Product
              <span
                className="text-3xl text-red-300 dark:text-gray-200"
                style={{
