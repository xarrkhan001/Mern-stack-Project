...
const Navbar = () => {
  ...
  return (
    <div className="max-w-[1140px] px-4 mx-auto">
      {/* Navbar container */}
      <div
        className={`flex items-center justify-between h-20 p-3 rounded-xl shadow-md text-black dark:text-white ${
      ...
      >
        ...
        <Link to="/" className="flex items-center space-x-1 sm:space-x-2">
          ...
          >
            ...
            <span className="text-3xl sm:text-4xl text-gray-500 dark:text-gray-400">
              Store
            </span>
          </span>
