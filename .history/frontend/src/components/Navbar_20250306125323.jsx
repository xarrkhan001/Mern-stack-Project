    ...
    <div className="max-w-[1140px] px-4 mx-auto">
      ...
      >
        ...
        <div className="flex items-center space-x-4">
          {/* Plus Icon */}
          <Link to="/create">
            <button className="w-10 h-10 bg-white dark:bg-gray-500 text-gray-600 dark:text-white rounded-full flex items-center justify-center transform hover:scale-125 transition-all duration-300 shadow-xl hover:shadow-2xl focus:outline-none">
              <FaPlus size={16} />
            </button>
          </Link>
          ...
          <button
            ...
            className="w-10 h-10 bg-white dark:bg-gray-500 text-[#FF4081] dark:text-white rounded-full flex items-center justify-center transform hover:scale-125 transition-all duration-300 shadow-xl hover:shadow-2xl focus:outline-none"
          >
            {isDarkMode ? (
