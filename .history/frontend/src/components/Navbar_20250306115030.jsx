      ...
      <div className="max-w-[1140px] px-4 mx-auto">
        ...
        >
          ...
          <Link to="/" className="flex items-center">
            ...
            >
              <span
                className="text-5xl font-semibold text-red-400 dark:text-red-400"
                style={{
          ...
          <div className="relative flex items-center space-x-4">
            {/* Plus Icon */}
            <Link to="/create">
              <button className="w-12 h-12 bg-white dark:bg-gray-500 text-gray-600 dark:text-white rounded-md flex items-center justify-center transform hover:scale-125 transition-all duration-300 shadow-xl hover:shadow-2xl focus:outline-none">
