      ...
      <div className="max-w-[1140px] px-4 mx-auto">
        ...
        <div className="flex items-center justify-between h-20 bg-transparent dark:bg-transparent p-4 rounded-xl shadow-lg text-black dark:text-white">
          ...
          <div className="relative flex items-center space-x-4">
            ...
            >
              {isDarkMode ? (
                <FaSun size={24} className="text-yellow-500" /> // Sun icon with yellow color for dark mode
              ) : (
                <FaMoon size={24} className="text-gray-600" /> // Moon icon with gray-600 color for light mode
              )}
            </button>
          </div>
        </div>
