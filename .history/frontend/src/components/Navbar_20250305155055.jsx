  ...
  return (
    <>
      <div className="max-w-[1140px] px-4 mx-auto">
        {/* Navbar container */}
        <div className="flex items-center justify-between h-20 bg-gradient-to-r from-[#4CAF50] to-[#388E3C] p-4 rounded-xl shadow-lg">
          {/* Left side - ProductStore logo */}
          <Link to="/" className="font-bold flex items-center space-x-2">
            <span className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#A5D6A7] to-[#4CAF50]">
              Product
            </span>
