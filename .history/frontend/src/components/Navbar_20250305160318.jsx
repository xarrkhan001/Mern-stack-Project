...
import { FaProductHunt } from "react-icons/fa"; // Import a product icon for logo
    ...
    <>
      <div className="max-w-[1140px] px-4 mx-auto">
        ...
        <div className="flex items-center justify-between h-20 bg-[#4B421B] p-4 rounded-xl shadow-lg">
          {/* Left side - ProductStore logo with an icon */}
          <Link to="/" className="flex items-center">
            {/* Product Icon + Text */}
            <FaProductHunt className="text-4xl text-[#fdf9f2] mr-2" />
